...
class TrainOptions:
	...
	def initialize(self):
		self.parser.add_argument('--exp_dir', type=str, default='exp',help='Path to experiment output directory')
		self.parser.add_argument('--dataset_type', default='ffhq_swap', type=str, help='Type of dataset/experiment to run')
		...
		self.parser.add_argument('--start_from_latent_avg', action='store_false', help='Whether to add average latent vector to generate codes from encoder.')
		self.parser.add_argument('--learn_in_w', action='store_true', help='Whether to learn in w space instead of w+')

		self.parser.add_argument('--lpips_lambda', default=0.8, type=float, help='LPIPS loss multiplier factor')
		self.parser.add_argument('--id_lambda', default=0.15, type=float, help='ID loss multiplier factor')
		self.parser.add_argument('--l2_lambda', default=1, type=float, help='L2 loss multiplier factor')
		self.parser.add_argument('--w_norm_lambda', default=0.0005, type=float, help='W-norm loss multiplier factor')
